                ...
                <div class="row match-height">
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-block">
                                    <p>Total paid invoices <span>$240</span>, unpaid <span>$150</span>. <span class="float-xs-right"><a href="{{url('admin/orders?list=true&all=1')}}" >Invoice Summary <i class="ft-arrow-right"></i></a></span></p>
                                </div>
